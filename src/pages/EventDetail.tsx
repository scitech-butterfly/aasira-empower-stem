...
const EventDetail = () => {
  ...
  const eventImage = event.image || "https://images.unsplash.com/photo-1486312338219-ce68d2c6f44d?ixlib=rb-4.0.3&auto=format&fit=crop&w=1740&q=80";
                ...
                <div className="space-y-4 mb-6">
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-white/70">{formatDateRange(event.date, event.end_date)}</p>
                    </div>
                  </div>
